...
namespace Library.Repository
{
    public class RepositoryTblSemester : IRepositoryTblSemester
    {
        ...
        public TblSemester GetSemesterByName(string name) => TblSemesterDAO.Instance.GetSemesterByName(name);
        public TblSemester GetSemterBySemesterID(int id) => TblSemesterDAO.Instance.GetSemterBySemesterID(id);
    }
}
