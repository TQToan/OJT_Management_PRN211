...
{
    public partial class OJT_MANAGEMENT_PRN211_Vs1Context : DbContext
    {
        public OJT_MANAGEMENT_PRN211_Vs1Context()
        {
        }

        public OJT_MANAGEMENT_PRN211_Vs1Context(DbContextOptions<OJT_MANAGEMENT_PRN211_Vs1Context> options)
            : base(options)
        {
        }
